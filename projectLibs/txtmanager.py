...
class TextManager(FileManager):
    """
       FileManager classından implement edilmis Text Dosyası Sınıfı
    """
    ...
    def replace_text_in_file(self,file_path,old_text:str,new_text:str)->int:
        with open(file_path) as file:
            content = file.read()
...
if __name__ == "__main__":
    path="yeniText.txt"
    # print("Gardaş baska kapıya,burdan sana ekmek cıkmazzz")
